...
- Experiment directory: `/workspace/experiments/by_id/exp0076__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p25__temp-2__cxr_foundation_linear_gpu`
...
python \
  ...
  --experiment-name \
  exp0076__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p25__temp-2__cxr_foundation_linear_gpu
```
...
- `d0_test` macro AUROC `0.829056`, macro AP `0.233404`
- `target_test` macro AUROC `0.785756`, macro AP `0.476147`
- `target_val` macro AUROC `0.737374`, macro AP `0.364855`
