...
- Experiment directory: `/workspace/experiments/by_id/exp0083__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-1p0__temp-4__cxr_foundation_linear_gpu`
...
python \
  ...
  --experiment-name \
  exp0083__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-1p0__temp-4__cxr_foundation_linear_gpu
```
...
- `d0_test` macro AUROC `0.839363`, macro AP `0.244531`
- `target_test` macro AUROC `0.799084`, macro AP `0.480995`
- `target_val` macro AUROC `0.737981`, macro AP `0.359733`
