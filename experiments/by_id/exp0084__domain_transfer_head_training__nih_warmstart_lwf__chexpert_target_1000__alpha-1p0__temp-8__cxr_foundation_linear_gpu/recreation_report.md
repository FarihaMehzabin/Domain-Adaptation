...
- Experiment directory: `/workspace/experiments/by_id/exp0084__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-1p0__temp-8__cxr_foundation_linear_gpu`
...
python \
  ...
  --experiment-name \
  exp0084__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-1p0__temp-8__cxr_foundation_linear_gpu
```
...
- `d0_test` macro AUROC `0.839449`, macro AP `0.244696`
- `target_test` macro AUROC `0.799058`, macro AP `0.480951`
- `target_val` macro AUROC `0.737970`, macro AP `0.359563`
