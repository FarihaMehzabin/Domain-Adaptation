...
- Experiment directory: `/workspace/experiments/by_id/exp0077__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p25__temp-4__cxr_foundation_linear_gpu`
...
python \
  ...
  --experiment-name \
  exp0077__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p25__temp-4__cxr_foundation_linear_gpu
```
...
- `d0_test` macro AUROC `0.829795`, macro AP `0.233983`
- `target_test` macro AUROC `0.785552`, macro AP `0.476236`
- `target_val` macro AUROC `0.737341`, macro AP `0.364508`
