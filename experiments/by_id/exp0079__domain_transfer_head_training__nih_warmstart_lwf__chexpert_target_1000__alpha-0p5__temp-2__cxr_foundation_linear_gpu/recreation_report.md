...
- Experiment directory: `/workspace/experiments/by_id/exp0079__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p5__temp-2__cxr_foundation_linear_gpu`
...
python \
  ...
  --experiment-name \
  exp0079__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p5__temp-2__cxr_foundation_linear_gpu
```
...
- `d0_test` macro AUROC `0.834455`, macro AP `0.240286`
- `target_test` macro AUROC `0.790853`, macro AP `0.478859`
- `target_val` macro AUROC `0.738079`, macro AP `0.362630`
