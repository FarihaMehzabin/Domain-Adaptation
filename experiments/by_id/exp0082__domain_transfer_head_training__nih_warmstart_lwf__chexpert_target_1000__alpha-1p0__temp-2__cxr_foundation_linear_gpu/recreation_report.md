...
- Experiment directory: `/workspace/experiments/by_id/exp0082__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-1p0__temp-2__cxr_foundation_linear_gpu`
...
python \
  ...
  --experiment-name \
  exp0082__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-1p0__temp-2__cxr_foundation_linear_gpu
```
...
- `d0_test` macro AUROC `0.838922`, macro AP `0.244243`
- `target_test` macro AUROC `0.798290`, macro AP `0.481404`
- `target_val` macro AUROC `0.738140`, macro AP `0.360116`
