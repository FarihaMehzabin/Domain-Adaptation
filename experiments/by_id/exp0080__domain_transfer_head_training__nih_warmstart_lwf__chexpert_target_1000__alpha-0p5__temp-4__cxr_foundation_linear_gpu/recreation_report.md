...
- Experiment directory: `/workspace/experiments/by_id/exp0080__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p5__temp-4__cxr_foundation_linear_gpu`
...
python \
  ...
  --experiment-name \
  exp0080__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p5__temp-4__cxr_foundation_linear_gpu
```
...
- `d0_test` macro AUROC `0.835010`, macro AP `0.240626`
- `target_test` macro AUROC `0.791444`, macro AP `0.479318`
- `target_val` macro AUROC `0.737979`, macro AP `0.362239`
