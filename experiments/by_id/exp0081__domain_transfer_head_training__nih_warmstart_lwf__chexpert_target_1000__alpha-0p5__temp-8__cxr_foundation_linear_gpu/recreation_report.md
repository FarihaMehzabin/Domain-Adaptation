...
- Experiment directory: `/workspace/experiments/by_id/exp0081__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p5__temp-8__cxr_foundation_linear_gpu`
...
python \
  ...
  --experiment-name \
  exp0081__domain_transfer_head_training__nih_warmstart_lwf__chexpert_target_1000__alpha-0p5__temp-8__cxr_foundation_linear_gpu
```
...
- `d0_test` macro AUROC `0.835179`, macro AP `0.240552`
- `target_test` macro AUROC `0.791482`, macro AP `0.479375`
- `target_val` macro AUROC `0.738017`, macro AP `0.362217`
