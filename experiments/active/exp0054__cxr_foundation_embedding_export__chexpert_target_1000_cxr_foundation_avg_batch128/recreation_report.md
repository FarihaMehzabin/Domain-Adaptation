...
- Experiment directory: `/workspace/experiments/active/exp0054__cxr_foundation_embedding_export__chexpert_target_1000_cxr_foundation_avg_batch128`
...
python \
  ...
  avg \
  --experiment-name \
  chexpert_target_1000_cxr_foundation_avg_batch128 \
  --overwrite
```
