...
- Experiment directory: `/workspace/experiments/active/exp0052__cxr_foundation_embedding_export__chexpert_target_500_cxr_foundation_avg_batch128`
...
python \
  ...
  avg \
  --experiment-name \
  chexpert_target_500_cxr_foundation_avg_batch128 \
  --overwrite
```
...
- `d1_chexpert/train`: `500` rows, embedding tail shape `768`, failures `0`
- `d1_chexpert/val`: `500` rows, embedding tail shape `768`, failures `0`
