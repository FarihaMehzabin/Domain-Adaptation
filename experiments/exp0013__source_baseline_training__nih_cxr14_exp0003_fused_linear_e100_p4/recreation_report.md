...
`/workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4`
...
- Experiment directory: `/workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4`
...
python \
  ...
  --fp16-on-cuda \
  --experiment-name \
  exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4 \
  --overwrite
```
...
```text
9f170dde0346f29e81866a90c78040a5c030c3079356c2f7aef5158e25abd453  /workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4/config.json
a170f7789ab1df65abf3a2b0940ad3c5d1b05b42d9ffd62950528b47142dbb33  /workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4/experiment_meta.json
9d7cdc6ed1a7ad40c901fa0fb2f8028d8d5bd96752336f91242908234bb44506  /workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4/best.ckpt
25e63bf2c48df905ad4d7b4637cf085a80060365f2121055d1996a69d3054d77  /workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4/val_metrics.json
eac986127507d59c2558079f395300c3105072603000f5b1cfeb0a6b775c3bab  /workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4/test_metrics.json
5a7bead9b7de8a2539cfa451e82e142ba7698cee9941fdf1d233dc0049d148be  /workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4/val_f1_thresholds.json
e6fbd5c7f31a57203f91a545d3838a0d8a98c3f6a8aebe5dac6b2325d510a4d7  /workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4/train_log.jsonl
```
...
```text
Use /workspace/scripts/04_train_frozen_multilabel_baseline.py and the report /workspace/experiments/exp0013__source_baseline_training__nih_cxr14_exp0003_fused_linear_e100_p4/recreation_report.md to recreate the frozen NIH CXR14 source baseline for embeddings from /workspace/experiments/exp0003__fused_embedding_generation__nih_cxr14_exp0001_exp0002_concat_l2. Run the exact command in the report, verify the saved metrics and checkpoint hashes, and confirm that validation-tuned thresholds are reused for test evaluation.
```
