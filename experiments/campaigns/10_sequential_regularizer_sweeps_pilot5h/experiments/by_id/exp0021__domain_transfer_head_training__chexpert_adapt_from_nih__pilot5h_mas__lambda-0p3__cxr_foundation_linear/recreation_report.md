...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0021__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-0p3__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0021__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-0p3__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.835877`, macro AP `0.245055`
- `d0_val` macro AUROC `0.833556`, macro AP `0.251012`
- `d2_test` macro AUROC `0.768250`, macro AP `0.397225`
- `d2_val` macro AUROC `0.785334`, macro AP `0.368348`
- `target_test` macro AUROC `0.812510`, macro AP `0.488867`
- `target_val` macro AUROC `0.730597`, macro AP `0.357421`
