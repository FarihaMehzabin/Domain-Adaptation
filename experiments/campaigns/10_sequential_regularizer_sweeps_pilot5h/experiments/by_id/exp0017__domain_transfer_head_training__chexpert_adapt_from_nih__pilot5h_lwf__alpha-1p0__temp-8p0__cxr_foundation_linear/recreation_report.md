...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0017__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-8p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0017__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-8p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.834133`, macro AP `0.239524`
- `d0_val` macro AUROC `0.833174`, macro AP `0.252649`
- `d2_test` macro AUROC `0.764927`, macro AP `0.396691`
- `d2_val` macro AUROC `0.785331`, macro AP `0.363173`
- `target_test` macro AUROC `0.809463`, macro AP `0.491501`
- `target_val` macro AUROC `0.735568`, macro AP `0.361610`
