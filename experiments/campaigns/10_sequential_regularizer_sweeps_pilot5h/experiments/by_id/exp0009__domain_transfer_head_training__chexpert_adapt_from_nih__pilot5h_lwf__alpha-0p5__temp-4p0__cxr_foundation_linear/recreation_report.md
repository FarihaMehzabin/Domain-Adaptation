...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0009__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-4p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0009__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-4p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.827297`, macro AP `0.232035`
- `d0_val` macro AUROC `0.824713`, macro AP `0.249019`
- `d2_test` macro AUROC `0.764847`, macro AP `0.396630`
- `d2_val` macro AUROC `0.782342`, macro AP `0.363746`
- `target_test` macro AUROC `0.796505`, macro AP `0.485813`
- `target_val` macro AUROC `0.736463`, macro AP `0.364907`
