...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0015__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-4p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0015__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-4p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.833944`, macro AP `0.239170`
- `d0_val` macro AUROC `0.833033`, macro AP `0.252501`
- `d2_test` macro AUROC `0.764895`, macro AP `0.396880`
- `d2_val` macro AUROC `0.785299`, macro AP `0.363237`
- `target_test` macro AUROC `0.809666`, macro AP `0.491589`
- `target_val` macro AUROC `0.735644`, macro AP `0.361557`
