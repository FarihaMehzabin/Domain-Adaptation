...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0003__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p25__temp-4p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0003__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p25__temp-4p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.821553`, macro AP `0.227856`
- `d0_val` macro AUROC `0.817842`, macro AP `0.242949`
- `d2_test` macro AUROC `0.764283`, macro AP `0.396062`
- `d2_val` macro AUROC `0.778994`, macro AP `0.361234`
- `target_test` macro AUROC `0.788392`, macro AP `0.481144`
- `target_val` macro AUROC `0.736215`, macro AP `0.365300`
