...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0030__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_mas__lambda-30p0__cxr_foundation_linear`
...
- Token pooling: `avg`
- Head type: `linear`
- Init checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0029__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-30p0__cxr_foundation_linear/best.ckpt`
...
- MAS enabled: `True`
- MAS state path: `/tmp/cxr_sequential_regularizer_sweeps/mas_states/mas_lambda-30p0/stage_b_chexpert_mas_state.pt`
- MAS lambda: `30.0`
- MLP hidden dims: `[]`
- MLP dropout: `0.2`
...
python \
  ...
  --experiment-name \
  exp0030__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_mas__lambda-30p0__cxr_foundation_linear \
  --split-profile \
  mimic_adapt_from_chexpert \
  --init-checkpoint \
  /tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0029__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-30p0__cxr_foundation_linear/best.ckpt \
  --enable-mas \
  --mas-state-path \
  /tmp/cxr_sequential_regularizer_sweeps/mas_states/mas_lambda-30p0/stage_b_chexpert_mas_state.pt \
  --mas-lambda \
  30.0 \
  --embedding-root \
...
- `d0_test` macro AUROC `0.846474`, macro AP `0.254816`
- `d0_val` macro AUROC `0.849702`, macro AP `0.268171`
- `d1_test` macro AUROC `0.847466`, macro AP `0.547556`
- `d1_val` macro AUROC `0.711751`, macro AP `0.336942`
- `target_test` macro AUROC `0.744423`, macro AP `0.381326`
- `target_val` macro AUROC `0.782924`, macro AP `0.360269`

## Notes

- Training uses only `target_train` embeddings.
- Auxiliary training aliases: `[]`.
- Initialization checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0029__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-30p0__cxr_foundation_linear/best.ckpt`.
- LwF teacher checkpoint: `None`.
- MAS state path: `/tmp/cxr_sequential_regularizer_sweeps/mas_states/mas_lambda-30p0/stage_b_chexpert_mas_state.pt`.
