...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0011__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-8p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0011__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-8p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.827465`, macro AP `0.232183`
- `d0_val` macro AUROC `0.824922`, macro AP `0.249465`
- `d2_test` macro AUROC `0.764808`, macro AP `0.396074`
- `d2_val` macro AUROC `0.782375`, macro AP `0.363743`
- `target_test` macro AUROC `0.796402`, macro AP `0.485783`
- `target_val` macro AUROC `0.736429`, macro AP `0.364868`
