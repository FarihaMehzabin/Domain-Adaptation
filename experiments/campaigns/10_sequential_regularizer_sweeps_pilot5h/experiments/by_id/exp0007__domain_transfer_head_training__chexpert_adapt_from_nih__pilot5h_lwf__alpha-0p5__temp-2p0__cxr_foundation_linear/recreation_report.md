...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0007__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-2p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0007__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-2p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.826705`, macro AP `0.231702`
- `d0_val` macro AUROC `0.824079`, macro AP `0.248250`
- `d2_test` macro AUROC `0.765003`, macro AP `0.397230`
- `d2_val` macro AUROC `0.782031`, macro AP `0.363272`
- `target_test` macro AUROC `0.796324`, macro AP `0.486307`
- `target_val` macro AUROC `0.736411`, macro AP `0.364799`
