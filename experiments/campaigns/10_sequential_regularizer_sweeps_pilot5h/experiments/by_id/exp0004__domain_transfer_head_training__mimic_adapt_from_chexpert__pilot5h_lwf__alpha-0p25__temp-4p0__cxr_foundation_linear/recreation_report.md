...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0004__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-0p25__temp-4p0__cxr_foundation_linear`
...
- Token pooling: `avg`
- Head type: `linear`
- Init checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0003__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p25__temp-4p0__cxr_foundation_linear/best.ckpt`
- Preservation method: `lwf`
- LwF enabled: `True`
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0003__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p25__temp-4p0__cxr_foundation_linear/best.ckpt`
- LwF alpha: `0.25`
- LwF temperature: `4.0`
- MAS enabled: `False`
- MAS state path: `None`
...
python \
  ...
  --experiment-name \
  exp0004__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-0p25__temp-4p0__cxr_foundation_linear \
  --split-profile \
  mimic_adapt_from_chexpert \
  --init-checkpoint \
  /tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0003__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p25__temp-4p0__cxr_foundation_linear/best.ckpt \
  --enable-lwf \
...
- `d0_test` macro AUROC `0.816650`, macro AP `0.219611`
- `d0_val` macro AUROC `0.821377`, macro AP `0.232391`
- `d1_test` macro AUROC `0.807617`, macro AP `0.516993`
- `d1_val` macro AUROC `0.722817`, macro AP `0.336707`
- `target_test` macro AUROC `0.771656`, macro AP `0.411993`
- `target_val` macro AUROC `0.804652`, macro AP `0.385508`

## Notes

- Training uses only `target_train` embeddings.
- Auxiliary training aliases: `[]`.
- Initialization checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0003__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p25__temp-4p0__cxr_foundation_linear/best.ckpt`.
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0003__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p25__temp-4p0__cxr_foundation_linear/best.ckpt`.
- MAS state path: `None`.
