...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0029__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-30p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0029__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-30p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.846135`, macro AP `0.256119`
- `d0_val` macro AUROC `0.849485`, macro AP `0.267608`
- `d2_test` macro AUROC `0.741099`, macro AP `0.378859`
- `d2_val` macro AUROC `0.780770`, macro AP `0.358031`
- `target_test` macro AUROC `0.847153`, macro AP `0.543599`
- `target_val` macro AUROC `0.710822`, macro AP `0.336783`
