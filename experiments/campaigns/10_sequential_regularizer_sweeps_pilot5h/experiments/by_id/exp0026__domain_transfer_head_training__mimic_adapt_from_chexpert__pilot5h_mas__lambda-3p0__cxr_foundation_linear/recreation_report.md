...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0026__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_mas__lambda-3p0__cxr_foundation_linear`
...
- Token pooling: `avg`
- Head type: `linear`
- Init checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0025__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-3p0__cxr_foundation_linear/best.ckpt`
...
- MAS enabled: `True`
- MAS state path: `/tmp/cxr_sequential_regularizer_sweeps/mas_states/mas_lambda-3p0/stage_b_chexpert_mas_state.pt`
- MAS lambda: `3.0`
- MLP hidden dims: `[]`
- MLP dropout: `0.2`
...
python \
  ...
  --experiment-name \
  exp0026__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_mas__lambda-3p0__cxr_foundation_linear \
  --split-profile \
  mimic_adapt_from_chexpert \
  --init-checkpoint \
  /tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0025__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-3p0__cxr_foundation_linear/best.ckpt \
  --enable-mas \
  --mas-state-path \
  /tmp/cxr_sequential_regularizer_sweeps/mas_states/mas_lambda-3p0/stage_b_chexpert_mas_state.pt \
  --mas-lambda \
  3.0 \
  --embedding-root \
...
- `d0_test` macro AUROC `0.845309`, macro AP `0.251840`
- `d0_val` macro AUROC `0.846256`, macro AP `0.262785`
- `d1_test` macro AUROC `0.839702`, macro AP `0.524986`
- `d1_val` macro AUROC `0.719429`, macro AP `0.343361`
- `target_test` macro AUROC `0.762180`, macro AP `0.393089`
- `target_val` macro AUROC `0.790935`, macro AP `0.369834`

## Notes

- Training uses only `target_train` embeddings.
- Auxiliary training aliases: `[]`.
- Initialization checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0025__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-3p0__cxr_foundation_linear/best.ckpt`.
- LwF teacher checkpoint: `None`.
- MAS state path: `/tmp/cxr_sequential_regularizer_sweeps/mas_states/mas_lambda-3p0/stage_b_chexpert_mas_state.pt`.
