...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0005__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p25__temp-8p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0005__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p25__temp-8p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.821691`, macro AP `0.228014`
- `d0_val` macro AUROC `0.818002`, macro AP `0.243094`
- `d2_test` macro AUROC `0.764346`, macro AP `0.396108`
- `d2_val` macro AUROC `0.779065`, macro AP `0.361356`
- `target_test` macro AUROC `0.788391`, macro AP `0.481401`
- `target_val` macro AUROC `0.736195`, macro AP `0.365295`
