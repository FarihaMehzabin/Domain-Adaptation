...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0018__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-1p0__temp-8p0__cxr_foundation_linear`
...
- Token pooling: `avg`
- Head type: `linear`
- Init checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0017__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-8p0__cxr_foundation_linear/best.ckpt`
- Preservation method: `lwf`
- LwF enabled: `True`
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0017__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-8p0__cxr_foundation_linear/best.ckpt`
- LwF alpha: `1.0`
- LwF temperature: `8.0`
- MAS enabled: `False`
- MAS state path: `None`
...
python \
  ...
  --experiment-name \
  exp0018__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-1p0__temp-8p0__cxr_foundation_linear \
  --split-profile \
  mimic_adapt_from_chexpert \
  --init-checkpoint \
  /tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0017__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-8p0__cxr_foundation_linear/best.ckpt \
  --enable-lwf \
...
- `d0_test` macro AUROC `0.831620`, macro AP `0.231175`
- `d0_val` macro AUROC `0.835744`, macro AP `0.246925`
- `d1_test` macro AUROC `0.823015`, macro AP `0.519331`
- `d1_val` macro AUROC `0.730889`, macro AP `0.350160`
- `target_test` macro AUROC `0.776827`, macro AP `0.415971`
- `target_val` macro AUROC `0.804751`, macro AP `0.389473`

## Notes

- Training uses only `target_train` embeddings.
- Auxiliary training aliases: `[]`.
- Initialization checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0017__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-8p0__cxr_foundation_linear/best.ckpt`.
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0017__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-8p0__cxr_foundation_linear/best.ckpt`.
- MAS state path: `None`.
