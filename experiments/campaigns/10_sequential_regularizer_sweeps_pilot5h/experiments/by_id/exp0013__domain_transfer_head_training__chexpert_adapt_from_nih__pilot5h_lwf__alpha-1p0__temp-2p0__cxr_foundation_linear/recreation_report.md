...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0013__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-2p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0013__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-2p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.833437`, macro AP `0.238695`
- `d0_val` macro AUROC `0.832460`, macro AP `0.253010`
- `d2_test` macro AUROC `0.764926`, macro AP `0.397112`
- `d2_val` macro AUROC `0.785153`, macro AP `0.363955`
- `target_test` macro AUROC `0.809238`, macro AP `0.490253`
- `target_val` macro AUROC `0.735855`, macro AP `0.361569`
