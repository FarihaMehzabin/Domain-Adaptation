...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0010__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-0p5__temp-4p0__cxr_foundation_linear`
...
- Token pooling: `avg`
- Head type: `linear`
- Init checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0009__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-4p0__cxr_foundation_linear/best.ckpt`
- Preservation method: `lwf`
- LwF enabled: `True`
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0009__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-4p0__cxr_foundation_linear/best.ckpt`
- LwF alpha: `0.5`
- LwF temperature: `4.0`
- MAS enabled: `False`
- MAS state path: `None`
...
python \
  ...
  --experiment-name \
  exp0010__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-0p5__temp-4p0__cxr_foundation_linear \
  --split-profile \
  mimic_adapt_from_chexpert \
  --init-checkpoint \
  /tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0009__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-4p0__cxr_foundation_linear/best.ckpt \
  --enable-lwf \
...
- `d0_test` macro AUROC `0.822964`, macro AP `0.223562`
- `d0_val` macro AUROC `0.827314`, macro AP `0.239089`
- `d1_test` macro AUROC `0.813246`, macro AP `0.517482`
- `d1_val` macro AUROC `0.727136`, macro AP `0.341698`
- `target_test` macro AUROC `0.775096`, macro AP `0.413601`
- `target_val` macro AUROC `0.805099`, macro AP `0.387336`

## Notes

- Training uses only `target_train` embeddings.
- Auxiliary training aliases: `[]`.
- Initialization checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0009__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-4p0__cxr_foundation_linear/best.ckpt`.
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0009__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-4p0__cxr_foundation_linear/best.ckpt`.
- MAS state path: `None`.
