...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0012__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-0p5__temp-8p0__cxr_foundation_linear`
...
- Token pooling: `avg`
- Head type: `linear`
- Init checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0011__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-8p0__cxr_foundation_linear/best.ckpt`
- Preservation method: `lwf`
- LwF enabled: `True`
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0011__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-8p0__cxr_foundation_linear/best.ckpt`
- LwF alpha: `0.5`
- LwF temperature: `8.0`
- MAS enabled: `False`
- MAS state path: `None`
...
python \
  ...
  --experiment-name \
  exp0012__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-0p5__temp-8p0__cxr_foundation_linear \
  --split-profile \
  mimic_adapt_from_chexpert \
  --init-checkpoint \
  /tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0011__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-8p0__cxr_foundation_linear/best.ckpt \
  --enable-lwf \
...
- `d0_test` macro AUROC `0.823471`, macro AP `0.223719`
- `d0_val` macro AUROC `0.827924`, macro AP `0.239302`
- `d1_test` macro AUROC `0.814276`, macro AP `0.518672`
- `d1_val` macro AUROC `0.727342`, macro AP `0.342107`
- `target_test` macro AUROC `0.775445`, macro AP `0.413876`
- `target_val` macro AUROC `0.805093`, macro AP `0.387269`

## Notes

- Training uses only `target_train` embeddings.
- Auxiliary training aliases: `[]`.
- Initialization checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0011__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-8p0__cxr_foundation_linear/best.ckpt`.
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0011__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-0p5__temp-8p0__cxr_foundation_linear/best.ckpt`.
- MAS state path: `None`.
