...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0014__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-1p0__temp-2p0__cxr_foundation_linear`
...
- Token pooling: `avg`
- Head type: `linear`
- Init checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0013__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-2p0__cxr_foundation_linear/best.ckpt`
- Preservation method: `lwf`
- LwF enabled: `True`
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0013__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-2p0__cxr_foundation_linear/best.ckpt`
- LwF alpha: `1.0`
- LwF temperature: `2.0`
- MAS enabled: `False`
- MAS state path: `None`
...
python \
  ...
  --experiment-name \
  exp0014__domain_transfer_head_training__mimic_adapt_from_chexpert__pilot5h_lwf__alpha-1p0__temp-2p0__cxr_foundation_linear \
  --split-profile \
  mimic_adapt_from_chexpert \
  --init-checkpoint \
  /tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0013__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-2p0__cxr_foundation_linear/best.ckpt \
  --enable-lwf \
...
- `d0_test` macro AUROC `0.829639`, macro AP `0.229201`
- `d0_val` macro AUROC `0.833797`, macro AP `0.244952`
- `d1_test` macro AUROC `0.820571`, macro AP `0.519018`
- `d1_val` macro AUROC `0.730033`, macro AP `0.348538`
- `target_test` macro AUROC `0.776086`, macro AP `0.416328`
- `target_val` macro AUROC `0.804725`, macro AP `0.389949`

## Notes

- Training uses only `target_train` embeddings.
- Auxiliary training aliases: `[]`.
- Initialization checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0013__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-2p0__cxr_foundation_linear/best.ckpt`.
- LwF teacher checkpoint: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0013__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_lwf__alpha-1p0__temp-2p0__cxr_foundation_linear/best.ckpt`.
- MAS state path: `None`.
