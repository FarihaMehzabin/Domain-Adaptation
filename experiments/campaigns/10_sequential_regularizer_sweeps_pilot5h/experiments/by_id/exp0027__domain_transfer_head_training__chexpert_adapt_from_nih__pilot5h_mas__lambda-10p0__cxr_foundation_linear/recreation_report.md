...
- Experiment directory: `/tmp/cxr_sequential_regularizer_sweeps/experiments/by_id/exp0027__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-10p0__cxr_foundation_linear`
...
python \
  ...
  --experiment-name \
  exp0027__domain_transfer_head_training__chexpert_adapt_from_nih__pilot5h_mas__lambda-10p0__cxr_foundation_linear \
  --split-profile \
...
- `d0_test` macro AUROC `0.846532`, macro AP `0.256907`
- `d0_val` macro AUROC `0.848923`, macro AP `0.267237`
- `d2_test` macro AUROC `0.745329`, macro AP `0.380893`
- `d2_val` macro AUROC `0.782330`, macro AP `0.359740`
- `target_test` macro AUROC `0.844987`, macro AP `0.529250`
- `target_val` macro AUROC `0.713124`, macro AP `0.339554`
