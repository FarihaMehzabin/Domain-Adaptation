#!/usr/bin/env python3
"""Fuse ViT-base NIH CXR14 image embeddings with CLS report embeddings."""
...
DEFAULT_IMAGE_ROOT = Path("/workspace/image_embeddings/vit-base-patch16-224")
...
DEFAULT_OUTPUT_ROOT = Path("/workspace/fused_embeddings_cls/vit-base-patch16-224")
...
def parse_args() -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(
        description=(
            "Run the shared NIH fused-embedding generator with ViT-base image embeddings "
