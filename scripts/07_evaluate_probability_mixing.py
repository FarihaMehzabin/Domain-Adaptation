...
DEFAULT_MEMORY_EVAL_ROOT = experiment_layout.find_experiment_dir("exp0006", experiments_root=DEFAULT_EXPERIMENTS_ROOT)
DEFAULT_BASELINE_EXPERIMENT_DIR = experiment_layout.find_experiment_dir(
    "exp0004",
    experiments_root=DEFAULT_EXPERIMENTS_ROOT,
)
DEFAULT_QUERY_EMBEDDING_ROOT = experiment_layout.find_experiment_dir(
    "exp0003",
    experiments_root=DEFAULT_EXPERIMENTS_ROOT,
)
