...
DEFAULT_TRAIN_EMBEDDINGS = Path("/workspace/image_embeddings/Dinov2-large/train/embeddings.npy")
DEFAULT_VAL_EMBEDDINGS = Path("/workspace/image_embeddings/Dinov2-large/train/val/embeddings.npy")
DEFAULT_TEST_EMBEDDINGS = Path("/workspace/image_embeddings/Dinov2-large/train/test/embeddings.npy")
...
DEFAULT_TRAIN_IMAGE_PATHS = Path("/workspace/image_embeddings/Dinov2-large/train/image_paths.txt")
DEFAULT_VAL_IMAGE_PATHS = Path("/workspace/image_embeddings/Dinov2-large/train/val/image_paths.txt")
DEFAULT_TEST_IMAGE_PATHS = Path("/workspace/image_embeddings/Dinov2-large/train/test/image_paths.txt")

DEFAULT_OUTPUT_ROOT = Path("/workspace/outputs/nih_cxr14_frozen_dinov2_linear")
